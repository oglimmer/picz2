 ...
 * original was purged by the retention CronJob (Phase 6 / Gap 4-finish). Distinct from {@link
 * ResourceNotFoundException} (404) so well-behaved clients can stop retrying.
 */
